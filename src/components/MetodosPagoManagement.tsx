...
const mockMetodosPago: MetodoPago[] = [
  ...
  {
    id_metodo_pago: 7,
    nombre_metodo: "CREDITO",
    descripcion: "Pago a crédito o al fiado",
    estado_logico: true,
  ...
  },
  {
    id_metodo_pago: 8,
    nombre_metodo: "VALE",
    descripcion: "Pago con vale de consumo",
    estado_logico: true,
    fecha_registro: "2026-03-05 09:15:00",
  },
  {
    id_metodo_pago: 9,
    nombre_metodo: "WALLET",
    descripcion: "Pago con billetera electrónica (PayPal, etc.)",
    estado_logico: true,
...
export default function MetodosPagoManagement({ isDark = true }: { isDark?: boolean }) {
  ...
  const filteredMetodos = useMemo(() => {
    return mockMetodosPago.filter((metodo) => {
      const matchesSearch =
    ...
    <div style={{ padding: "24px", background: t.mainBg, minHeight: "100vh" }}>
        ...
        >
          ...
          <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", position: "relative", zIndex: 1 }}>
            <div>
              ...
              <p style={{ fontSize: "36px", fontWeight: 700, color: "#ffffff", marginBottom: "8px", lineHeight: 1 }}>
                {mockMetodosPago.filter((m) => m.estado_logico).length}
              </p>
              <div style={{ display: "flex", alignItems: "center", gap: "6px" }}>
      ...
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "16px", flexWrap: "wrap", gap: "12px" }}>
        <p style={{ fontSize: "13px", color: t.textSecondary, fontWeight: 500 }}>
          Mostrando {startIndex + 1}-{Math.min(endIndex, filteredMetodos.length)} de {filteredMetodos.length} métodos de pago
        </p>
